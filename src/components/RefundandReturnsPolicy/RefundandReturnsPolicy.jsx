...
import "./RefundandReturnsPolicy.css";

export default function RefundandReturnsPolicy() {
  return (
    <div className="RefundandReturnsPolicy">
      <div className="refund">
        <div className="refund-col-1">
          ...
          <p className="sub-head">Late or missing refunds</p>
          <p className="text">
          ...
          <p className="head">Shipping returns</p>
          <p className="text">
